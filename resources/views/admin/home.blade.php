            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li> <a href="{{ route('jenjang.index') }}" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Data Jenjang Pendidikan</span></a>
                            <li> <a href="{{ route('pendidikan.index') }}" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Data Pendidikan</span></a>
                            <li> <a href="{{ route('bidang.index') }}" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Data Bidang Profesi</span></a>
