                ...
                <div class="col-lg-12">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <table class="table" id="dynamic_field">
                                            <tr>
                                                <td>
                                                    <input type="text" name="jenjang[]" placeholder="Masukkan Jenjang Pendidikan"
                                                        class="form-control" />
                                                </td>
                                                <td>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-offset-3 col-sm-9 text-right">
                            <a href="{{ route('jenjang.index') }}" class="btn btn-info waves-effect waves-light m-t-10">Batal</a>
        ...
        $(document).ready(function () {
            ...
            $('#add').click(function () {
                ...
                $('#dynamic_field').append('<tr id="row' + i +
                    '" class="dynamic-added"><td><input type="text" name="jenjang[]" placeholder="Masukkan Jenjang Pendidikan" class="form-control" /></td><td><button type="button" name="remove" id="' +
