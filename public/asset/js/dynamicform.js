    ...
    $(document).ready(function(){
        ...
        var adaw= $.get("buatkodepekerjaan/"+ $('#hasilpekerjaan > option').length,function(data, status){
        var html = '';
        html += '<tr>';
        html += '<td><select id="hasilpekerjaan"  readonly name="kode_pekerjaan[]" placeholder="Masukan Kode Pekerjaan" class="form-control item_kode_pekerjaan" required><option value="'+ data +'">'+ data +'</option></select></td>';
    ...
    $(document).ready(function(){   
        ...
        var adaw= $.get("buatkodepraktik/"+  $('#hasilpraktik > option').length ,function(data, status){
        var html = '';
        html += '<tr>';
        html += '<td><select id="hasilpraktik" readonly name="kode_praktik[]" placeholder="Masukan Kode Praktik" class="form-control item_kode_praktik" required><option value="'+ data +'">'+ data +'</option></select></td>';
    ...
    $(document).ready(function(){      
        ...
        var adaw= $.get("buatkodepengembanganpro/"+  $('#hasilpro > option').length ,function(data, status){
        var html = '';
        html += '<tr>';
        html += '<td><select id="hasilpro" readonly name="kode_pro[]" placeholder="Masukan Kode Profesional" class="form-control item_kode_pro" required><option value="'+ data +'">'+ data +'</option></select></td>';
